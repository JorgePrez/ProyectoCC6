            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-12  d-flex justify-content-center">
                        <form id="form1" id=cuadro1 action="enviarcomotienda.php" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="row" >
                                ...
                                <div class="col-4  d-flex justify-content-center align-items-center">
                                    <input name="direccion" type="text" class="form-control" id="direccion"></input> 
                                </div>
                            </div> 
                            ...
                            <div class="row" >
                                ...
                                <div class="col-4  d-flex justify-content-center align-items-center">
                                <select name="destino" type="text" class="form-control" id="destino">                                    
                                    <?php                                
                            ...
                            <div class="row" >
                                <div class="col-8  d-flex justify-content-center align-items-center">
                                    <h2> <label for="tienda">Tienda:</label> </h2> 
                                </div>
                                <div class="col-4  d-flex justify-content-center align-items-center">
                                <select name="tienda" type="text" class="form-control" id="tienda">                                    
                                    <?php                                
                                    ...
                                    while ($row = pg_fetch_row($result)) {
                                        $codigotienda= $row[0];
                                        $nombretienda= $row[1];
                                    echo '<option value="'.$codigotienda.'">'."$nombretienda".'</option>';
                                    }
                                    ?>
                                    </select>                                            
                                </div>
