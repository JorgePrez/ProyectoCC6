      ...
      <div class="container h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="row" >
              ...
              $direccionremitente= $_POST['direccionremitente'];
              $origen= $_POST['origen'];
              ...
              $costo=($costoorigen+$costodestino)/2;
            
                $query = "INSERT INTO ordenes VALUES ('$orden','$destinatario','$direcciondestinatario','$remitente','$direccionremitente',$costo,1,$origen,$destino);";
