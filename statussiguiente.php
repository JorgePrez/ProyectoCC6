      ...
      <div class="container h-100">
          <div class="row h-100 align-items-center justify-content-center text-center">
              ...
              <?php
                    ...
                    $query="select * from orden where numeroorden='$orden'";
                    $statusreal=0;
                    ...
                    if($rows!=0){
                      $statusnuevo=$statusreal+1;
          

                      $query2="update orden set numerostatus = $statusnuevo WHERE numeroorden = '$orden'";
                      ...
                      $query2="select * from ordenes where numeroorden='$orden'";
                      $statusreal=0;
                      $result2 = pg_query($conn, $query2) or die('ERROR : ' . pg_last_error());
                      ...
                      $query2="update ordenes set numerostatus = $statusnuevo WHERE numeroorden = '$orden'";
                      $result2 = pg_query($conn, $query2) or die('ERROR : ' . pg_last_error());
              ...
              <div class="col-12 justify-content-center">
                  ...
                  <form action="/statussiguiente.php" method="get">
