      ...
      <h2 class="text-uppercase font-weight-bold"></h2>
        ...
        <h2 class="text-uppercase font-weight-bold">Ingrese sus datos para cotizar su orden</h2>
          ...
          <?php
              ...
              <form id="form1" id=cuadro1 action="cotizarweb2.php".php method="get" class="needs-validation" novalidate>
...
<div class="row" >
    ...
    <button class="btn btn-danger btn-xl js-scroll-trigger" type="submit">Cotizar</button>                                                                                                       
    </div>                                          
</div>
</form>
