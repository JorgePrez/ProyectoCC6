      ...
      <div class="container h-100">
         <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-end">
                  <h2 class="text-uppercase text-white font-weight-bold">Destino Registrado Correctamente</h2>
               ...
               <div class="row" >
                  ...
                  $query = "INSERT INTO ciudad VALUES ($codigopostal,'$nombreciudad',$costo);";
