  ...
  <body id="page-top">
    ...
    <div class="row fila align-items-center justify-content-center text-center">
      ...
      <h2 class="text-uppercase font-weight-bold"></h2>
        ...
        <h2 class="text-uppercase font-weight-bold">Confirme sus datos</h2>
          ...
          <?php
              ...
              <form id="form1" id=cuadro1 action="confirmarenviadoweb.php".php method="get" class="needs-validation" novalidate>
...
<div class="row" >
  ...
  <div class="col-4  d-flex justify-content-center align-items-center">
    <?php
  echo "<input name='remitente' type='text' readonly  value='$remitente' class='form-control' id='destino'>";     
  ?>                               
...
<div class="row" >
  ...
  echo "<input name='remitentedir' type='text' readonly value='$remitentedir' class='form-control' id='remitentedir'>";  
  ?>                               
...
<div class="row" >
  ...
  <div class="col-4  d-flex justify-content-center align-items-center">
  <?php
  echo "<input name='destinatario' type='text' readonly value='$destinatario' class='form-control' id='destinatario'>";                                   
  ?>                               
...
<div class="row" >
  ...
  echo "<input name='destinatariodir' type='text' readonly value='$destinatariodir'  class='form-control' id='destinatariodir'> ";
  ?>                                  
...
<div class="row" >
  ...
  <div class="col-4  d-flex justify-content-center align-items-center">
  <?php
    echo "<input name='preciototal' type='text' readonly value='$preciostring' class='form-control' id='precio'>";  
...
<div class="row" >
  ...
  <button class="btn btn-primary btn-xl js-scroll-trigger" type="submit">Confirmar</button>                                                                                                       
  </div>         
