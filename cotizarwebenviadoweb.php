...
<html lang="en">
  <head>
    ...
    <title>Cotizar Web Enviado</title>
      ...
      <h2 class="text-uppercase font-weight-bold"></h2>
        ...
        <h2 class="text-uppercase font-weight-bold">Orden Realizada Correctamente</h2>
          ...
          <?php
              ...
              $query = "INSERT INTO ordenes VALUES ('$numeroorden','$destinatario','$destinatariodir','$remitente','$remitentedir',$precio,1,'$origen','$destino',null);";
