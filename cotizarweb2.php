      ...
      <h2 class="text-uppercase font-weight-bold"></h2>
        ...
        <h2 class="text-uppercase font-weight-bold">Ingrese sus datos para cotizar su orden</h2>
          ...
          <?php
              ...
              <form id="form1" id=cuadro1 action="cotizarwebenviar.php" method="get" class="needs-validation" novalidate>
...
<div class="row" >
    <div class="col-12  d-flex justify-content-center align-items-center">
    <button class="btn btn-primary btn-xl js-scroll-trigger" type="submit">Completar Detalles Envio</button>                                                                                                       
    </div>                                          
</div>
